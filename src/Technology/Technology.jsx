...
//     if (action === "read") {
//       navigate(`/technology/${itemId}`);
//       return;
//     }
//     if (action === "view") {
//       dispatch(incrementPostView(itemId));
//       return;
//     }
...
//     if (action === "like") {
//       if (userLikes.has(itemId)) return;
//       dispatch(togglePostLike({ postId: itemId, email: userInfo.email }));
...
//         ...prev,
//         [pendingItemId]: { comments: result.payload?.comments || [] },
//       }));
...
//                 const itemId = news._id || news.id;
//                 const hasLiked = userLikes.has(itemId);
...
//                           <button
//                             onClick={() => handleAction("like", itemId)}
...
//                           </button>
//                           <button
//                             onClick={() => handleAction("comment", itemId)}
//                             className="flex items-center gap-1 hover:text-red-500 transition-colors"
//                           >
//                             <MessageCircle className="w-5 h-5" />
//                             {(news.comments?.length || 0) +
//                               (updatedItems[itemId]?.comments?.length || 0)}
//                           </button>
//                         </div>
//                         <button
//                           onClick={() => handleAction("read", itemId)}
