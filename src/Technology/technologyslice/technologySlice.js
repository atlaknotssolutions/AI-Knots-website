...
// //     try {
// //       const res = await fetch("https://ai-knots-it-solution-4.onrender.com/api/technology/category");
...
// //     try {
// //       let url = "https://ai-knots-it-solution-4.onrender.com/api/technology/product";
...
// // //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}`
// // //       );
...
// //     try {
// //       const res = await fetch(
// //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}`   // ← Correct
// //       );
...
// //     try {
// //       const res = await fetch(
// //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/view`,
// //         { method: "PUT" }
// //       );
// //       const data = await res.json();
...
// //     try {
// //       const res = await fetch(
// //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/like`,
// //         {
// //           method: "PUT",
...
// //     try {
// //       const res = await fetch(
// //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/send-otp`,
// //         {
// //           method: "POST",
// //           headers: { "Content-Type": "application/json" },
...
// //     try {
// //       const res = await fetch(
// //         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/add-comment`,
// //         {
// //           method: "POST",
// //           headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(
//         `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/comment`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
//           body: JSON.stringify({ email, otp, comment }),
...
export const fetchCategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(
        "https://ai-knots-it-solution-4.onrender.com/api/technology/category",
      );
      if (!res.ok) throw new Error("Failed to fetch categories");
      const data = await res.json();
      return Array.isArray(data.data) ? data.data : [];
...
export const fetchProducts = createAsyncThunk(
  ...
  async (categoryId, { rejectWithValue }) => {
    try {
      let url =
        "https://ai-knots-it-solution-4.onrender.com/api/technology/product";
      if (categoryId) url += `?category=${categoryId}`;
...
export const verifyCommentOtp = createAsyncThunk(
  ...
  async ({ slug, email, otp }, { rejectWithValue }) => {
    try {
      const res = await fetch(
        `https://ai-knots-it-solution-4.onrender.com/api/technology/product/technology/${slug}/verify-otp`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
