...
//     try {
//       const res = await fetch("https://ai-knots-it-solution-5.onrender.com/api/blogcategory");
...
//   async (_, { rejectWithValue }) => {
//     try {
//       const res = await fetch("https://ai-knots-it-solution-5.onrender.com/api/product");
...
//     try {
//       const res = await fetch(`https://ai-knots-it-solution-5.onrender.com/api/product/${postId}`);
...
//         `https://ai-knots-it-solution-5.onrender.com/api/product/${postId}/view`,
//         {
//           method: "PUT",
//         },
//       );
...
//       const res = await fetch(
//         `https://ai-knots-it-solution-5.onrender.com/api/product/${postId}/like`,
//         {
//           method: "PUT",
...
//       const res = await fetch(
//         `https://ai-knots-it-solution-5.onrender.com/api/product/${postId}/send-otp`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(
//         `https://ai-knots-it-solution-5.onrender.com/api/product/${postId}/verify-otp`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
//     try {
//       const res = await fetch(
//         `https://ai-knots-it-solution-5.onrender.com/api/product/${postId}/comment`,
//         {
//           method: "POST",
//           headers: { "Content-Type": "application/json" },
...
export const fetchCategories = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(
        "https://ai-knots-it-solution-5.onrender.com/api/blogcategory",
      );
      if (!res.ok) throw new Error("Failed to fetch categories");
      const data = await res.json();
      if (!data.success) throw new Error(data.message || "Failed");
...
export const fetchBlogPosts = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const res = await fetch(
        "https://ai-knots-it-solution-5.onrender.com/api/product",
      );
      if (!res.ok) throw new Error("Failed to fetch posts");
      const data = await res.json();
      if (!data.success) throw new Error(data.message || "Failed");
...
export const fetchBlogPostById = createAsyncThunk(
  ...
  async (identifier, { rejectWithValue }) => {
    ...
    try {
      ...
      const res = await fetch(
        `https://ai-knots-it-solution-5.onrender.com/api/product/${identifier}`,
      );
      if (!res.ok) throw new Error("Post not found");
