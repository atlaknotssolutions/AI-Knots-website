...
// //               />
// //               <SocialLink
// //                 href="https://in.pinterest.com/atlaknotssolutions/?actingBusinessId=1097893352818742083"
// //                 icon={<Pinterest size={22} />}
// //                 label="Pinterest"
// //                 isDark={isDark}
// //               />
// //               <SocialLink
// //                 href="https://www.linkedin.com/company/atla-knots-solutions/?viewAsMember=true"
...
// import ATLAknotsLight from "../../src/assets/Images/logoimage2.PNG"; // ← Fixed path
...
//             <div className="flex gap-6 mt-8">
//               <SocialLink href="https://www.facebook.com/profile.php?id=61588297089600" icon={<Facebook size={22} />} label="Facebook" isDark={isDark} />
//               <SocialLink href="https://in.pinterest.com/atlaknotssolutions/?actingBusinessId=1097893352818742083" icon={<Pinterest size={22} />} label="Pinterest" isDark={isDark} />
//               <SocialLink href="https://www.linkedin.com/company/atla-knots-solutions/?viewAsMember=true" icon={<Linkedin size={22} />} label="LinkedIn" isDark={isDark} />
//               <SocialLink href="https://www.instagram.com/atlaknotsitsolutions/" icon={<Instagram size={22} />} label="Instagram" isDark={isDark} />
//             </div>
//           </div>
...
//           <div className="flex flex-wrap gap-6 justify-center">
//             <Link to="/privacypolicy" onClick={(e) => handleFooterLink(e, "/privacypolicy")} className={`transition-colors ${isDark ? "hover:text-red-400" : "hover:text-red-500"}`}>
//               Privacy Policy
//             </Link>
//             <Link to="/termsofservice" onClick={(e) => handleFooterLink(e, "/termsofservice")} className={`transition-colors ${isDark ? "hover:text-red-400" : "hover:text-red-500"}`}>
//               Terms of Service
//             </Link>
//             <Link to="/cookiepolicy" onClick={(e) => handleFooterLink(e, "/cookiepolicy")} className={`transition-colors ${isDark ? "hover:text-red-400" : "hover:text-red-500"}`}>
//               Cookie Policy
//             </Link>
//           </div>
//         </div>
